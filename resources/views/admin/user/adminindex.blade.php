                        ...
                        <tbody>
                            @forelse ($admins as $branch)
                                <tr>
                                    ...
                                    <td>
                                        <a href="https://wa.me/88{{ $branch->whatsapp }}" target="_blank">{{ $branch->whatsapp }}</a>
                                    </td>

                                    <td>
                                        <button type="button" class="btn btn-sm btn-primary editBtn" data-toggle="modal" data-target="#editModal"
                                        data-id="{{ $branch->id }}" data-name="{{ $branch->name }}" data-mobile="{{ $branch->mobile }}" data-whatssapp="{{ $branch->whatsapp }}" data-address="{{ $branch->address }}" data-email="{{ $branch->email }}">
                                            Edit
                                        </button>
